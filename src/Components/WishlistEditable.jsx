...
export default function Wishlist({cancel, editFormData, handleWishlistEditFormChange}) {
  return(<Tr>
    <Th><Input name="brand" value={editFormData.brand} required="required" onChange={handleWishlistEditFormChange} /></Th>
    <Th><Input name="itemName" value={editFormData.itemName} required="required" onChange={handleWishlistEditFormChange} /></Th>
    <Th>
